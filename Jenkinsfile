        ...
        stage('Clone GitHub Repo') {
            steps {
                script {
                    ...
                    checkout scmGit(branches: [[name: '*/master']], extensions: [], userRemoteConfigs: [[credentialsId: 'github-token', url: 'https://github.com/kali-cttc-aiml/RAG-MEDICAL-CHATBOT.git']])
                }
            }
        }
